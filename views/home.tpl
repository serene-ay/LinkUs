  ...
  <div id="app">
    ...
    <div class="all-cards">
        ...
        <section class="container">
            <a href="" class="card">
                <div class="card-image home" @click="button('location','home')"></div>
                <h2>Home</h2>
            </a>
            <a href="" class="card">
                <div class="card-image university" @click="button('location','university')"></div>
                <h2>University</h2>
            </a>
        </section>
        <section class="container">
            <a href="" class="card">
                <div class="card-image shop" @click="button('location','shop')"></div>
                <h2>Shop</h2>
            </a>
            <a href="" class="card">
                <div class="card-image park" @click="button('location','park')"></div>
                <h2>Park</h2>
            </a>
        </section>
    </div>
